...
#define AP_SCRIPTING_ENABLED ENABLED
#endif

#ifndef MODE_HYBRID_ENABLED
#define MODE_HYBRID_ENABLED ENABLED
#endif
...
#define HAL_ADSB_ENABLED DISABLED
#endif
...
#define HAL_BUTTON_ENABLED DISABLED
#endif
...
// קונפיגורציית המסגרת
#ifndef MULTICOPTER_FRAME
#define MULTICOPTER_FRAME 2
#endif
...
// קלאס מנועים
  ...
  #else
    #define MOTOR_CLASS AP_Motors_Hybrid
  #endif
#endif
...
#define MODE_FLOWHOLD_ENABLED DISABLED
#endif
