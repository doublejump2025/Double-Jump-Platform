...
#include <AP_Motors/AP_Motors_Hybrid.h>
...
void Copter::allocate_motors(void)
{
    switch ((AP_Motors::motor_frame_class)g2.frame_class.get()) {
        ...
        default:
        #ifdef MOTOR_CLASS
            motors = new MOTOR_CLASS(scheduler.get_loop_rate_hz());
            motors_var_info = MOTOR_CLASS::var_info;
        #else
            motors = new AP_MotorsMatrix(scheduler.get_loop_rate_hz());
            motors_var_info = AP_MotorsMatrix::var_info;
        #endif
            break;
        case AP_Motors::MOTOR_FRAME_HYBRID:
            motors = new AP_Motors_Hybrid(scheduler.get_loop_rate_hz());
            motors_var_info = AP_Motors_Hybrid::var_info;
            break;
        case AP_Motors::MOTOR_FRAME_TRI:
            motors = new AP_MotorsTri(scheduler.get_loop_rate_hz());
            motors_var_info = AP_MotorsTri::var_info;
            AP_Param::set_frame_type_flags(AP_PARAM_FRAME_TRICOPTER);
            break;
        case AP_Motors::MOTOR_FRAME_SINGLE:
            motors = new AP_MotorsSingle(scheduler.get_loop_rate_hz());
            motors_var_info = AP_MotorsSingle::var_info;
            break;
        case AP_Motors::MOTOR_FRAME_COAX:
            motors = new AP_MotorsCoax(scheduler.get_loop_rate_hz());
            motors_var_info = AP_MotorsCoax::var_info;
            break;
        case AP_Motors::MOTOR_FRAME_TAILSITTER:
            motors = new AP_MotorsTailsitter(scheduler.get_loop_rate_hz());
            motors_var_info = AP_MotorsTailsitter::var_info;
            break;
#if AP_SCRIPTING_ENABLED
        case AP_Motors::MOTOR_FRAME_6DOF_SCRIPTING:
            motors = new AP_MotorsMatrix_6DoF_Scripting(scheduler.get_loop_rate_hz());
            motors_var_info = AP_MotorsMatrix_6DoF_Scripting::var_info;
            break;
        case AP_Motors::MOTOR_FRAME_DYNAMIC_SCRIPTING_MATRIX:
            motors = new AP_MotorsMatrix_Scripting_Dynamic(scheduler.get_loop_rate_hz());
            motors_var_info = AP_MotorsMatrix_Scripting_Dynamic::var_info;
            break;
#endif
#else // FRAME_CONFIG == HELI_FRAME
        case AP_Motors::MOTOR_FRAME_HELI_DUAL:
            motors = new AP_MotorsHeli_Dual(scheduler.get_loop_rate_hz());
            motors_var_info = AP_MotorsHeli_Dual::var_info;
            AP_Param::set_frame_type_flags(AP_PARAM_FRAME_HELI);
            break;

        case AP_Motors::MOTOR_FRAME_HELI_QUAD:
            motors = new AP_MotorsHeli_Quad(scheduler.get_loop_rate_hz());
        ...
        default:
            motors = new AP_MotorsHeli_Single(scheduler.get_loop_rate_hz());
