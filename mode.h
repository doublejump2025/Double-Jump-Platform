// Simple solution: Just add the minimal required forward declarations to mode.h
...
// Ensure PRECISION_LANDING is defined before use
...
public:
    ...
    enum class Number : uint8_t {
        ...
        HYBRID =       29,  // Hybrid mode, which is a combination of manual and automatic control
    ...
    virtual bool allows_arming(uint8_t method) const = 0;
...
#if defined(PRECISION_LANDING) && PRECISION_LANDING == ENABLED
...
public:
    ...
    bool allows_arming(uint8_t method) const override;
...
public:
    ...
    bool allows_arming(uint8_t method) const override { return false; }
    bool is_autopilot() const override { return false; }
